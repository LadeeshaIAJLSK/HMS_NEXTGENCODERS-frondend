...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <div className="max-w-6xl w-full mx-4 sm:mx-auto flex flex-col md:flex-row shadow-2xl rounded-2xl overflow-hidden relative z-10 bg-white">
...
<div className="absolute inset-0 bg-gradient-to-br from-[#1e2a78]/90 to-[#006b57]/90"></div>
          ...
          <div className="relative p-8 text-white h-full flex flex-col justify-center">
            ...
            <p className="text-lg text-blue-100 mb-8">Create an account to access our hotel management system</p>
            <div className="space-y-4 text-blue-100">
              <div className="flex items-center">
                <svg className="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"/>
                </svg>
                <span>Manage Staff Efficiently</span>
              </div>
              <div className="flex items-center">
                <svg className="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center">
                <svg className="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M5 3a2 2 0 012-2h6a2 2 0 012 2v11h-4v4H7v-4H3V3z"/>
                </svg>
        ...
        <div className="md:w-1/2 p-8 md:p-12 bg-white">
          ...
          {error && (
            <div className="mb-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r" role="alert">
